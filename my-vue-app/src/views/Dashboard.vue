...
import guangdong from '@/geo/guangdong.json'
import guangxi from '@/geo/guangxi.json'
import fujian from '@/geo/fujian.json'
export default {
  name: 'Dashboard',
  setup() {
...
const getSimpleMapOption = () => {
  ...
  const geo = mapData[adcode];
  if (!geo) {
    console.error('没有找到地图数据:', adcode);
    return;
  }
